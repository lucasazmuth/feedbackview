                      ...
                      <Column gap="m">
                        ...
                        {selectedFeedback.userAgent && (
                          <Column gap="xs">
                            ...
                            <Text variant="body-default-xs" style={{ wordBreak: 'break-all' }}>{selectedFeedback.userAgent}</Text>
                          </Column>
                        )}
                        ...
                        <Column gap="xs">
                          ...
                          <Column gap="xs">
                            ...
                            <Row gap="xs" vertical="center">
                              ...
                              <Text variant="body-default-xs">{selectedFeedback.consoleLogs?.length ?? 0} console logs</Text>
                            </Row>
                            <Row gap="xs" vertical="center">
                              <Icon name="openLink" size="xs" />
                              <Text variant="body-default-xs">{selectedFeedback.networkLogs?.length ?? 0} requisições de rede</Text>
                            </Row>
                          </Column>
                        </Column>
                      </Column>
