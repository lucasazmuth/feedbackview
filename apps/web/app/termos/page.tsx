        ...
        <Column maxWidth={48} fillWidth paddingX="l" paddingY="xl" gap="l">
          ...
          <Column gap="m">
            ...
            <Text variant="body-default-m" onBackground="neutral-weak" style={{ lineHeight: 1.7 }}>
              Ao acessar e usar o QBugs, você concorda com estes Termos de Uso. Se você não concorda com algum destes termos, não utilize nossos serviços. O uso continuado da plataforma constitui aceitação de quaisquer alterações feitas nestes termos.
            </Text>

            <Heading variant="heading-strong-m" as="h2">2. Descrição do Serviço</Heading>
            <Text variant="body-default-m" onBackground="neutral-weak" style={{ lineHeight: 1.7 }}>
              O QBugs é uma plataforma de QA (Quality Assurance) que permite capturar screenshots, session replays, logs de console e rede automaticamente junto a reports de bugs e sugestões. O serviço inclui um widget embarcável, link compartilhável e painel de gerenciamento.
            </Text>

            <Heading variant="heading-strong-m" as="h2">3. Cadastro e Conta</Heading>
            <Text variant="body-default-m" onBackground="neutral-weak" style={{ lineHeight: 1.7 }}>
              Para usar o QBugs, você deve criar uma conta fornecendo informações verdadeiras e completas. Você é responsável por manter a confidencialidade de suas credenciais e por todas as atividades realizadas em sua conta. Notifique-nos imediatamente caso suspeite de uso não autorizado.
            </Text>

            <Heading variant="heading-strong-m" as="h2">4. Uso Aceitável</Heading>
            <Text variant="body-default-m" onBackground="neutral-weak" style={{ lineHeight: 1.7 }}>
              Você concorda em usar o QBugs apenas para fins legais e de acordo com estes termos. É proibido: (a) usar o serviço para atividades ilegais; (b) tentar acessar áreas restritas da plataforma; (c) interferir no funcionamento do serviço; (d) coletar dados de outros usuários sem consentimento.
            </Text>

            <Heading variant="heading-strong-m" as="h2">5. Propriedade Intelectual</Heading>
            <Text variant="body-default-m" onBackground="neutral-weak" style={{ lineHeight: 1.7 }}>
              Todo o conteúdo da plataforma QBugs, incluindo textos, gráficos, logos, ícones e software, é protegido por leis de propriedade intelectual. Você mantém a propriedade dos dados enviados através da plataforma, concedendo-nos uma licença limitada para processar e armazenar esses dados conforme necessário para a prestação do serviço.
            </Text>

            <Heading variant="heading-strong-m" as="h2">6. Limitação de Responsabilidade</Heading>
            <Text variant="body-default-m" onBackground="neutral-weak" style={{ lineHeight: 1.7 }}>
              O QBugs é fornecido &ldquo;como está&rdquo;. Não garantimos que o serviço será ininterrupto ou livre de erros. Em nenhuma circunstância seremos responsáveis por danos indiretos, incidentais ou consequenciais decorrentes do uso ou impossibilidade de uso do serviço.
            </Text>
