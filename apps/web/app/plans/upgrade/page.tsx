        ...
        <Column fillWidth padding="l" gap="m" radius="l" border="neutral-medium" background="surface">
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.875rem' }}>
              ...
              <tbody>
                {[
                  { feature: 'Projetos', free: '1', pro: '5', business: 'Ilimitados' },
                  { feature: 'Reports/mês', free: '50', pro: 'Ilimitados', business: 'Ilimitados' },
                  { feature: 'Membros', free: '1', pro: '10', business: '50' },
                  ...
                  { feature: 'Integrações', free: '—', pro: 'Slack, Jira', business: 'Slack, Jira, Linear, Webhook' },
